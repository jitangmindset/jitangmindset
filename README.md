...
<p align="center">
  I create Windows applications, experiment with interfaces<br>
  and enjoy turning rough ideas into complete, usable products.
</p>

## About me

- I am focused on desktop development, application security and browser integrations.
- I enjoy working on both the visible interface and the systems behind it.
- I care about clean visuals, understandable behavior and software that feels complete.
- Games and server infrastructure are another area where I like to experiment and build tools.
...
<p>
  ...
  <img alt="Lua" src="https://img.shields.io/badge/Lua-111111?style=for-the-badge&logo=lua&logoColor=5B6DEE">
